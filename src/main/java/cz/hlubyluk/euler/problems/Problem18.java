 ...
 *
 * <p>NOTE: As there are only 16384 routes, it is possible to solve this problem by trying every
 * route. However, Problem 67, is the same challenge with a triangle containing one-hundred rows; it
