 ...
 *
 * <p>If the numbers 1 to 5 are written out in words: one, two, three, four, five, then there are 3
 ...
 *
 * <p>NOTE: Do not count spaces or hyphens. For example, 342 (three hundred and forty-two) contains
 * 23 letters and 115 (one hundred and fifteen) contains 20 letters.
 *
 * <p>The use of "and" when writing out numbers is in compliance with British usage.
 *
